...
func (f *updateFactory) Capabilities() []protocolcatalog.CapabilityID {
	return []protocolcatalog.CapabilityID{
		protocolcatalog.CapabilityIDUpdate, protocolcatalog.CapabilityIDWorkflowTaskControl,
		protocolcatalog.CapabilityIDHistoryObservation,
	}
}

func (f *updateFactory) Prepare(ctx context.Context, experiment protocolexperiment.Experiment) (environment.PreparedEnvironment, error) {
	if f.probe == nil {
...
func (s *updateSession) Realize(ctx context.Context, action protocolexperiment.Action, bindings environment.Bindings) (environment.ActionEvidence, error) {
...
func (s *updateSession) environmentIdentity(capabilities []protocolcatalog.CapabilityID) environment.EnvironmentIdentity {

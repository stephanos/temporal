...
import Temporal.Veil.NexusCancellationFencing.Sound
import Temporal.Veil.NexusCancellationFencing.SoundConcrete
import Temporal.Veil.NexusCancellationFencing.SoundConcreteSemantics
...
def soundBinding : Umpire3.Veil.ResolvedBinding :=
  resolved_veil_binding% soundFirstOrderView NexusCancellationSound
...
def soundBindingExport : Option Umpire3.Veil.BindingExport :=
  soundFirstOrderExport.bind (Umpire3.Veil.BindingExport.of soundBinding)

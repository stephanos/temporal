...
type Entry struct {
	...
	Fidelity             protocol.Fidelity      `json:"fidelity"`
	EvidenceLevel        protocol.EvidenceLevel `json:"evidenceLevel"`
...
func (l Ledger) Validate() error {
	...
	for _, entry := range l.Entries {
		...
		case protocol.FidelityExact, protocol.FidelitySemanticEquivalent, protocol.FidelityPartial:
		...
		case protocol.EvidenceLocalIntegration, protocol.EvidenceProfileQualified:
		case protocol.EvidenceInventory, protocol.EvidenceModelProof:
			if entry.Fidelity == protocol.FidelityExact || entry.Fidelity == protocol.FidelitySemanticEquivalent {

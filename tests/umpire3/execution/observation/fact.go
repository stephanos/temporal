...
const (
	...
	NexusOperationRetryableFailure     = "nexus-operation-retryable-failure"
	NexusOperationSettledAfterRetry    = "nexus-operation-settled-after-retry"
	NexusProgressDeadlineExpired       = "nexus-progress-deadline-expired"
...
func (f Fact) factTypeAndKind() (factType string, kind string) {
	switch {
	case f.History != nil:

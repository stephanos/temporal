...
import (
	...
	mutationaudit "go.temporal.io/server/tests/umpire3/assurance/audit/mutation"
	"go.temporal.io/server/tests/umpire3/assurance/audit/resilience"
...
func Run(arguments []string, stdout io.Writer) error {
	...
	modelRoot := flags.String("model-root", "tests/umpire3/model", "path to the Umpire3 Lean model")
	...
	releaseTemplate := flags.String("release-template", "tests/umpire3/assurance/release/testdata/generated/umpire3-1.3.json",
		"candidate release template")
	releaseExperiments := flags.String("release-experiments",
		"tests/umpire3/testdata/generated/nexus-cancellation.json,tests/umpire3/testdata/generated/update-lifecycle.json",
		"comma-separated release experiments")
	migrationLedger := flags.String("migration-ledger", "tests/umpire3/assurance/migration/testdata/generated/ledger.json",
		"release migration ledger")
	checkerNativeCertificate := flags.String("checker-native-certificate",
		"tests/umpire3/checker/finite/testdata/generated/nexus-cancellation-scale.certificate.json",
		"native certificate for checker coverage")
	checkerNativeReceipt := flags.String("checker-native-receipt",
		"tests/umpire3/checker/finite/testdata/generated/nexus-cancellation-scale.receipt.json",
		"native receipt for checker coverage")
	checkerNativeBenchmark := flags.String("checker-native-benchmark",
		"tests/umpire3/checker/finite/testdata/retained/nexus-cancellation-scale.benchmark.json",
		"native scale benchmark for checker coverage")
	checkerVeilBinding := flags.String("checker-veil-binding",
		"tests/umpire3/checker/veil/testdata/generated/nexus-cancellation-sound.json",
		"Veil binding for checker coverage")
	checkerVeilResults := flags.String("checker-veil-results",
		"tests/umpire3/checker/veil/testdata/retained/nexus-cancellation-sound-concrete.json,"+
			"tests/umpire3/checker/veil/testdata/retained/nexus-cancellation-sound-symbolic.json,"+
			"tests/umpire3/checker/veil/testdata/retained/nexus-cancellation-sound-invariant.json",
		"comma-separated Veil results for checker coverage")
	mutationExperiment := flags.String("mutation-experiment",
		"tests/umpire3/testdata/generated/nexus-cancellation.json", "experiment for the semantic mutation audit")
...
func exportReleaseCandidate(
	...
	for index := range release.ExternalQualifications {
		release.ExternalQualifications[index].Command = fmt.Sprintf(
			"go run -tags test_dep ./tests/umpire3/cmd/umpire3 qualify -profile %s "+
				"-release tests/umpire3/assurance/release/testdata/generated/umpire3-1.3.json "+

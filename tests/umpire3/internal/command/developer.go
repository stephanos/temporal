...
import (
	...
	"go.temporal.io/server/tests/umpire3/internal/generate"
	"go.temporal.io/server/tests/umpire3/internal/generate/api"
	"go.temporal.io/server/tests/umpire3/internal/generate/family"
...
func writeMigration(arguments []string) error {
	...
	output := flags.String("output", "tests/umpire3/assurance/migration/testdata/generated/ledger.json",

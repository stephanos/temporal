...
artifacts as hostile input. Strict decoders reject unknown fields and size/depth violations before
...
digest. They contain a redacted result, required profile/capabilities, seed, bounds, and a secret-free
...
The generic SDK runner has no fault authority. Restricted faults require both explicit runtime
opt-in and a profile-owned realizer that reports positive scoped occurrence evidence; absence of a

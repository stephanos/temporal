...
type ExecuteCandidate func(context.Context, protocol.Experiment) (umpire3execution.Result, error)
...
func isRequestedViolation(experiment protocol.Experiment, result umpire3execution.Result) bool {

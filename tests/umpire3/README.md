...
```sh
make umpire3-explain EXPERIMENT=tests/umpire3/testdata/generated/update-lifecycle.json
...
The supported CLI is `go run -tags test_dep ./tests/umpire3/cmd/umpire3`. Separate canary,

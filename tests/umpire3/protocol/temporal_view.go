...
//go:embed generated/task-delivery-progress.temporal.json
var defaultTaskDeliveryTemporalJSON []byte

//go:embed generated/task-delivery-progress-mutated.temporal.json
var defaultTaskDeliveryMutatedTemporalJSON []byte

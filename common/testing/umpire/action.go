...
// Temporal realizers) are declared behind tools/umpire2.
type Action struct {
	Name     string
	Kind     Kind
	Hosting  Hosting
	...
	// discovered by observing a drive, not declared here (see tools/umpire2 fault execution:
	...
	// tools/umpire2 footprint reconciliation) to catch drift a refactor introduces —

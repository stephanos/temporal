...
| `umpire.semantic-inventory.known-gap-source.17-request-raw-known-gap-input` | `Temporal.Tool.RunEvaluation` | carried | production | admitted-known-gap-input | `umpire.run-evaluation.request-and-raw-known-gap-input` | — | Validated request and Raw Evidence Known Gaps before stage-specific projection. |

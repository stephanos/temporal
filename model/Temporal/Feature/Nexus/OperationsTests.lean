...
#check (Temporal.Feature.Nexus.Operations.AsyncStart.behavior : CheckedScenario)
...
#check (Temporal.Feature.Nexus.Operations.Cancellation.behavior : CheckedScenario)
...
#check (Temporal.Feature.Nexus.Operations.SuccessfulCompletion.behavior : CheckedScenario)

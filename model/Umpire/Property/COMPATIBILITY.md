...
| `tools/umpire/internal/artifactv2` | The same three-field `Property` identity inside canonical ExperimentSpec v2 JSON | The retained generated-view reader validates the Experiment artifact version, exact fields, canonical order, digest syntax, checksums, and closure. It does not interpret Property clauses; unknown JSON fields and unsupported artifact majors fail at this narrow boundary. Other internal artifact codecs remain pending the separate orphan trim. |

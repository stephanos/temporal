...
import (
	...
	fakegrpc "go.temporal.io/server/tools/gomad1/api/ext-lib/fakegprc"
	pb "go.temporal.io/server/tools/gomad1/api/ext-lib/fakegprc/fixture"
	SIMAPI "go.temporal.io/server/tools/gomad1/api/lang"
	SIMLIB "go.temporal.io/server/tools/gomad1/api/lib"
	"go.temporal.io/server/tools/gomad1/runtime/testutil"

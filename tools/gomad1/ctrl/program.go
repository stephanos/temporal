...
import (
	...
	transformer "go.temporal.io/server/tools/gomad1/transformer"
	"go.temporal.io/server/tools/gomad1/util/verify"
)
...
import (
	...
	SIMLIB "go.temporal.io/server/tools/gomad1/api/lib"
	SIM "go.temporal.io/server/tools/gomad1/runtime"
)

...
// from go/src/runtime/race/testdata/race_test.go

func TestNoRaceAtomicAddInt64(_ *testing.T) {
	var x1, x2 int8
	_ = x1 + x2
	var s int64
	ch := make(chan bool, 2)
...
func TestRaceAtomicAddInt64(_ *testing.T) {
	var x1, x2 int8
	_ = x1 + x2
	var s int64
	ch := make(chan bool, 2)
...
func TestNoRaceAtomicAddInt32(_ *testing.T) {
	var x1, x2 int8
	_ = x1 + x2
	var s int32
	ch := make(chan bool, 2)
...
func TestNoRaceAtomicLoadAddInt32(_ *testing.T) {
	var x int64
	_ = x
	var s int32
	go func() {
...
func TestNoRaceAtomicLoadStoreInt32(_ *testing.T) {
	var x int64
	_ = x
	var s int32
	go func() {
...
func TestNoRaceAtomicStoreCASInt32(_ *testing.T) {
	var x int64
	_ = x
	var s int32
	go func() {
...
func TestNoRaceAtomicCASLoadInt32(_ *testing.T) {
	var x int64
	_ = x
	var s int32
	go func() {
...
func TestNoRaceAtomicCASCASInt32(_ *testing.T) {
	var x int64
	_ = x
	var s int32
	go func() {
...
func TestNoRaceAtomicCASCASInt32_2(_ *testing.T) {
	var x1, x2 int8
	_ = x1 + x2
	var s int32
	ch := make(chan bool, 2)
...
func TestNoRaceAtomicLoadInt64(_ *testing.T) {
	var x int32
	_ = x
	var s int64
	go func() {
...
func TestNoRaceAtomicCASCASUInt64(_ *testing.T) {
	var x int64
	_ = x
	var s uint64
	go func() {
...
func TestNoRaceAtomicLoadStorePointer(_ *testing.T) {
	var x int64
	_ = x
...
func TestNoRaceAtomicStoreCASUint64(_ *testing.T) {
	var x int64
	_ = x
	var s uint64
	go func() {
...
func TestRaceAtomicStoreLoad(_ *testing.T) {
	c := make(chan bool)
	var a uint64
	go func() {
...
func TestRaceAtomicLoadStore(_ *testing.T) {
	c := make(chan bool)
	var a uint64
	go func() {
...
func TestRaceAtomicAddLoad(_ *testing.T) {
	c := make(chan bool)
	var a uint64
	go func() {
...
func TestRaceAtomicAddStore(_ *testing.T) {
	c := make(chan bool)
	var a uint64
	go func() {
		atomic.AddUint64(&a, 1)
...
func TestNoRaceAtomicCrash(_ *testing.T) {
...
func TestNoRaceDeferAtomicStore(t *testing.T) {
	// XXX: this test causes flakes in eg TestRaceChanSendLen
	t.Skip()

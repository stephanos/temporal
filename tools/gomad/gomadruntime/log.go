...
var (
	logLevel      = flag.String("log-level", "ERROR", "gomad slog log level")
	forceChecksum = flag.Bool("force-checksum", false, "gomad force reproducibility checksumming and logging")
)

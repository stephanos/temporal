...
func activityDeliveryVerification() verificationFamilyFragment {
	...
	schedule.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_activity_delivery.go", Symbol: schedule.Name}
	...
	retry.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_activity_delivery.go", Symbol: retry.Name}
	...
	resolve.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_activity_delivery.go", Symbol: resolve.Name}
	...
	property := verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/protocol/verification_activity_delivery.go", Symbol: "activity.delivery.intent-correspondence"},
	}
	...
	return verificationFamilyFragment{
		Model: verify.Model{
			...
			Abstractions: []verify.Abstraction{{
				...
				Source: verify.Provenance{Path: "tools/umpire2/protocol/regress_domain.go", Symbol: "nexus.start_activity"},
			}},

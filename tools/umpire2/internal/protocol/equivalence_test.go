...
import (
	...
	v1action "go.temporal.io/server/tools/umpire1/action"
	v1fact "go.temporal.io/server/tools/umpire1/fact"
	v1model "go.temporal.io/server/tools/umpire1/model"
	v1planner "go.temporal.io/server/tools/umpire1/planner"
	umpirev2 "go.temporal.io/server/tools/umpire2"
	v2action "go.temporal.io/server/tools/umpire2/internal/action"
	v2fact "go.temporal.io/server/tools/umpire2/internal/fact"
	v2model "go.temporal.io/server/tools/umpire2/internal/model"

...
func callbackReferenceProperty(callback, operation, workflowRun string) verify.Property {
	return verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/rule/callback_reference_consistency.go", Symbol: "CallbackReferenceConsistencyRule"},
	}
}
...
func callbackResponseProperty() verify.Property {
	return verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/rule/callback_response_consistency.go", Symbol: "CallbackResponseConsistencyRule"},
	}
}
...
func callbackVerificationSource(symbol string) verify.Provenance {
	return verify.Provenance{Path: "tools/umpire2/protocol/verification_callback.go", Symbol: symbol}
}

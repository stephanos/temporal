...
func workflowDeliveryVerification() verificationFamilyFragment {
	...
	adapter.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_workflow_delivery.go", Symbol: adapter.Name}
	...
	resolve.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_workflow_delivery.go", Symbol: resolve.Name}
	...
	property := verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/rule/workflow_task_starvation.go", Symbol: "WorkflowTaskStarvationRule"},
	}

...
func NexusActivityLinkConsistencyProperties() []verify.Property {
	source := verify.Provenance{Path: "tools/umpire2/rule/nexus_activity_link_consistency.go", Symbol: "NexusActivityLinkConsistencyRule"}
...
func NexusActivityStrengtheningProperties() []verify.Property {
	return []verify.Property{{
		...
		Source: verify.Provenance{
			Path:   "tools/umpire2/protocol/regress_domain.go",

...
func workflowTaskSpeculativeSource(symbol string) verify.Provenance {
	return verify.Provenance{Path: "tools/umpire2/protocol/verification_workflow_task_speculative.go", Symbol: symbol}
}

func workflowTaskRuleSource(symbol, file string) verify.Provenance {
	return verify.Provenance{Path: "tools/umpire2/rule/" + file, Symbol: symbol}
}

...
func nexusOperationClosureProperty(workflow, operation string) verify.Property {
	return verify.Property{
		...
		Strengthening: true,
		Source:        verify.Provenance{Path: "tools/umpire2/rule/nexus_operation_closure.go", Symbol: "NexusOperationClosureRule"},
	}
}
...
func nexusOperationTimeoutProperty(operation string) verify.Property {
	return verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/rule/nexus_operation_timeout_semantics.go", Symbol: "NexusOperationTimeoutSemanticsRule"},
	}
}
...
func nexusVerificationSource(symbol string) verify.Provenance {
	return verify.Provenance{Path: "tools/umpire2/protocol/verification_nexus.go", Symbol: symbol}
}

...
func featureDeliveryAuthorizationAction(
	...
	action.Source = verify.Provenance{Path: "tools/umpire2/protocol/verification_delivery_authorization.go", Symbol: name}
	return action
}
...
func featureAcceptedStartProperty(
	...
	return verify.Property{
		...
		Source: verify.Provenance{Path: "tools/umpire2/protocol/verification_delivery_authorization.go", Symbol: name},
	}
}

...
// tools/umpire2/regress. Reusable runners use [RunRegression], [Plan], and [Judge] with explicit
// requests and results. Explicit action plans use the semantic ActionRunner in tools/umpire2.

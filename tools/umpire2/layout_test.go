...
func TestPackageLayout(t *testing.T) {
	...
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire"))
	require.DirExists(t, filepath.Join(repoRoot, "tools", "umpire1"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire1", "protocolv2"))
	require.DirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "internal", "protocol"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "protocol"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "assurance"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "fact"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "model"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "rule"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "action"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "planner"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "ksdriver"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "kitchensink"))
	require.DirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "internal", "kitchensink"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "regress", "rpc"))
	require.NoFileExists(t, filepath.Join(repoRoot, "tools", "umpire2", "entity_key.go"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "genmodels"))
	require.NoDirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "genmodels-results"))
	require.DirExists(t, filepath.Join(repoRoot, "tools", "umpire2", "testdata", "genmodels"))
	...
	requirePackageNames(t, filepath.Join(repoRoot, "tools", "umpire1"), "umpire1")
	requirePackageNames(t, filepath.Join(repoRoot, "tools", "umpire2", "internal", "protocol"), "protocol", "protocol_test")
	requireNoProductionImports(t, filepath.Join(repoRoot, "tools", "umpire2"), "go.temporal.io/server/tools/umpire1")
	requireNoRootProductionImports(t, filepath.Join(repoRoot, "tools", "umpire2"), "go.temporal.io/server/tests/testcore")
	requireNoExactProductionImport(t, filepath.Join(repoRoot, "tools", "umpire2", "internal"), "go.temporal.io/server/tests/testcore")
	requireNoProductionImports(t, filepath.Join(repoRoot, "common", "testing", "umpire"), "go.temporal.io/server/tools/umpire2")
	...
	requireNoGenericChangedCalls(t, filepath.Join(repoRoot, "tools", "umpire2", "internal", "rule"))
}

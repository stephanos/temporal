...
import (
	...
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/database/sql"
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/database/sql/driver"
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/fakegprc"
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/fakegprc/otlpmetric"
	...
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/net/http/pprof"
	_ "go.temporal.io/server/tools/gomadv1/api/ext-lib/nettrace"

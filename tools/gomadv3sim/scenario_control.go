...
const ScenarioChoicePlanSchema = "gomadv3.scenario-choice-plan/v1"
...
func scenarioChoiceOverrideIdentity(override ScenarioChoiceOverride) (string, error) {
	...
	return hashCanonical("gomadv3-scenario-choice-override/v1", override)
}
...
func scenarioChoicePlanIdentity(plan ScenarioChoicePlan) (string, error) {
	...
	return hashCanonical("gomadv3-scenario-choice-plan/v1", plan)
}

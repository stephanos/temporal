...
import (
	...
	sim_runtime "go.temporal.io/server/tools/gomad_old/runtime"
	transformer "go.temporal.io/server/tools/gomad_old/transformer"
	"go.temporal.io/server/tools/gomad_old/util/verify"
)
...
import (
	...
	SIMLIB "go.temporal.io/server/tools/gomad_old/api/lib"
	SIM "go.temporal.io/server/tools/gomad_old/runtime"
)

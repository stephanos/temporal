...
func renderGeneratedTest(input generationInput) ([]byte, error) {
	...
	generated.WriteString("\trequire.True(t, ok)\n")
	...
	generated.WriteString("\t\trequire.NoError(t, os.MkdirAll(filepath.Dir(absolute), 0o700))\n")
	generated.WriteString("\t\trequire.NoError(t, os.WriteFile(absolute, encoded, 0o600))\n")
	generated.WriteString("\t}\n")
	generated.WriteString("}\n\n")
	generated.WriteString("func runCallerClosureEvaluation(t *testing.T, admitted artifact.AdmittedSet) {\n")
	generated.WriteString("\tt.Helper()\n")
	generated.WriteString("\trepositoryRoot, err := filepath.Abs(filepath.Join(\"..\", \"..\", \"..\", \"..\"))\n")
	generated.WriteString("\trequire.NoError(t, err)\n")
	generated.WriteString("\texecutionRoot := t.TempDir()\n")
	generated.WriteString("\twriteCallerClosureExecution(t, executionRoot, admitted)\n")
	generated.WriteString("\toutputRoot := t.TempDir()\n")
	generated.WriteString("\tctx, cancel := context.WithTimeout(context.Background(), 180*time.Second)\n")
	...
	generated.WriteString("\tvar output bytes.Buffer\n")
	generated.WriteString("\tcommand.Stdout = &output\n")
	generated.WriteString("\tcommand.Stderr = &output\n")
	generated.WriteString("\trequire.NoError(t, command.Run(), output.String())\n")
	generated.WriteString("\trequire.NoError(t, ctx.Err())\n")
	generated.WriteString("}\n\n")
	...
	generated.WriteString("\trunCallerClosureEvaluation(t, output.AdmittedSet())\n")
	generated.WriteString("}\n")

...
func TestDescriptorMergePlanningAndRenderingAreDeterministic(t *testing.T) {
	...
	firstPlan, err := buildLeanPlan(firstProjection, fixtureTestConfiguration)
	require.NoError(t, err)
	secondPlan, err := buildLeanPlan(secondProjection, fixtureTestConfiguration)
	require.NoError(t, err)
	require.Equal(t, renderArtifacts(firstPlan), renderArtifacts(secondPlan))
}

func TestRenderArtifactsPreservesEmptyPlanBytes(t *testing.T) {
	plan, err := buildLeanPlan(projection{}, fixtureTestConfiguration)
	require.NoError(t, err)

	require.Equal(t, map[string][]byte{
		"Fixture/API.lean": []byte(`-- Code generated by umpire-gen-lean-api. DO NOT EDIT.
...
`),
		"Fixture/API/Proto.lean": []byte(`-- Code generated by umpire-gen-lean-api. DO NOT EDIT.
-- This is a structural descriptor projection, not behavioral semantics.
...
`),
		"Fixture/API/Types.lean": []byte(`-- Code generated by umpire-gen-lean-api. DO NOT EDIT.
-- This is a structural descriptor projection, not behavioral semantics.
import Fixture.API.Proto
...
func TestRunRejectsPlannerFailureBeforeCreatingOutput(t *testing.T) {
	directory := t.TempDir()
	descriptorPath := filepath.Join(directory, "empty-package.pb")
	outputRoot := filepath.Join(directory, "output")
	encoded := marshalDescriptorSet(t, &descriptorpb.FileDescriptorProto{
		Name:   proto.String("empty-package.proto"),
		Syntax: proto.String("proto3"),
		MessageType: []*descriptorpb.DescriptorProto{{
			Name: proto.String("Record"),
		}},
	})
	require.NoError(t, os.WriteFile(descriptorPath, encoded, 0o600))
	...
	require.ErrorContains(t, err, "empty protobuf package")
	_, statErr := os.Stat(outputRoot)
	require.ErrorIs(t, statErr, os.ErrNotExist)
}

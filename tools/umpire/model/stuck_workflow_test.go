...
func TestStuckWorkflowModel_NoIssues(t *testing.T) {
	...
	m := &model.StuckWorkflowModel{Threshold: 30 * time.Second}
	err := m.Init(context.Background(), umpire.Deps{
...
func TestStuckWorkflowModel_IgnoresCompletedWorkflows(t *testing.T) {
	...
	now := time.Now()
	completedWorkflow := &entity.Workflow{
		WorkflowID:  "test-workflow",
		NamespaceID: "default",
...
func TestStuckWorkflowModel_IgnoresRecentlyStartedWorkflows(t *testing.T) {
	...
	now := time.Now()
	recentWorkflow := &entity.Workflow{
		WorkflowID:  "test-workflow",
		NamespaceID: "default",
...
func TestStuckWorkflowModel_MultipleWorkflows(t *testing.T) {
	...
	stuckWorkflow1 := &entity.Workflow{
	...
	stuckWorkflow2 := &entity.Workflow{

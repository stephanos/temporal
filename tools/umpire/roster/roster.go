...
func (r *Registry) RouteEvents(ctx context.Context, events []scorebooktypes.Move) error {
	...
	entityIdentities := make(map[string]*rostertypes.Identity)
...
func (r *Registry) getOrCreateEntity(ident *rostertypes.Identity) (Entity, error) {
	if ident == nil {
		return nil, nil
	}
	...
	if ident.ParentID != nil {
		parentIdentity := &rostertypes.Identity{
...
func identityKey(ident *rostertypes.Identity) string {
	if ident == nil {
		return ""
	}
...
func entityIDKey(id *rostertypes.EntityID) string {
	if id == nil {
		return ""
	}
...
func (r *Registry) saveEntity(e Entity, ident *rostertypes.Identity) error {
	if ident == nil {

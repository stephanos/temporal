// Package evaluationcontract owns structural packing and admission for portable Umpire contracts.
...
// ErrorCode identifies the admission invariant that rejected a contract.
...
// AdmissionError reports a fail-closed contract admission failure.

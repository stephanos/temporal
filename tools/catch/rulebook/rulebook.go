...
// Registry manages model registration and initialization.
...
func NewRegistry() *Registry {
	...
	// TODO: Register default models here once import cycle is resolved
	// r.Register("losttask", func() Model { return &rules.LostTaskModel{} })
	// r.Register("stuckworkflow", func() Model { return &rules.StuckWorkflowModel{} })
	// r.Register("retryresilience", func() Model { return &rules.RetryResilienceModel{} })
	// r.Register("taskdeliveryguarantees", func() Model { return &rules.TaskDeliveryGuaranteesModel{} })
	// r.Register("workflowlifecycleinvariants", func() Model { return &rules.WorkflowLifecycleInvariantsModel{} })
	return r
}
...
// The initialized models are stored in the registry.
func (r *Registry) InitModels(ctx context.Context, names []string, deps interface{}) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *Registry) Check(ctx context.Context) []Violation {
	r.mu.RLock()
	defer r.mu.RUnlock()

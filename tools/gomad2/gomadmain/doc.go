/*
Gomad is a tool for working with gomad simulation testing framework.

Usage: gomad <command> [arguments]
...
module must have a dependency on gomad by importing
'github.com/temporalio/gomad' somewhere in the code.
...
-step flag is the step to pause at as seen in the logs from running 'gomad test'.

...
func TestRequirementsRejectsUnselectedAdapterIdentity(t *testing.T) {
	_, err := Default().Requirements(target.CapabilityClosure{Packages: []target.CapabilityPackage{}}, []record.TargetAdapter{{Module: "modernc.org/libc", Version: "changed", Sum: "h1:changed"}})

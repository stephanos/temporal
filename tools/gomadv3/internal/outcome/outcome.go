...
func Classify(result process.Result, cancelled bool, terminal record.WorldTerminal) Classification {
...
func setTargetTermination(classified *Classification, result process.Result) {
	if result.Termination == process.TerminationSignal {

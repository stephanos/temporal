...
func newSeedCampaign(selection SeedSelection, completed map[uint64]struct{}, parallel int, policy FailurePolicy, failureBudget uint64, summary *Summary) *seedCampaign {

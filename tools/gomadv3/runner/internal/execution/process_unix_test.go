...
func TestDescriptorPlanOwnsEveryStageLayout(t *testing.T) {
	tests := map[string]struct {
		...
		"target replay choices": {
			stage: targetStage, caps: launchCapabilities{choiceTrace: true, choiceReplayPlan: true},
		...
		"target all replay capabilities": {
			stage: targetStage, caps: launchCapabilities{ioTranscript: true, readOnlyMount: true, choiceTrace: true, choiceReplayPlan: true},

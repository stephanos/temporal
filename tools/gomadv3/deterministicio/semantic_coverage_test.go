...
func TestDecodeSemanticCoverageReturnsStableSortedBoundaryProbes(t *testing.T) {
	...
	if coverage.Schema != "gomadv3.semantic-coverage/v1" || !slices.Equal(coverage.Probes, wantProbes) || coverage.Digest != Digest("sha256:877093d0a648ac4ad279f69ebcec942a4fa9d5ddc852d3e5ffab2fea79a3ca0e") {
...
func TestSemanticInstrumentationIdentityBindsProbeNamesAndStableIDs(t *testing.T) {
	...
	if boundaryVersion != "go1.26.4-darwin-arm64-v1" || boundaryDigest != Digest("sha256:febc956871f3bd6885b4af2daed7653705eb6f03d5df2784decea946a849aa14") {

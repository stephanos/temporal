...
func (profile Spec) Requirements(closure target.CapabilityClosure, adapters []Adapter) ([]Requirement, error) {
...
func addAdapterRequirementEvidence(evidence map[string]map[target.CapabilityPackageReference]struct{}, closure target.CapabilityClosure, adapters []Adapter) error {

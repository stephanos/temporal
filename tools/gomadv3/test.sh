...
validate_overlay() {
	...
	while IFS= read -r -d '' file; do
		...
		if [[ $path != src/internal/gomadfs/fs.go && $path != src/internal/gomadfs/fs_test.go && $path != src/internal/gomadio/gomadio.go && $path != src/internal/gomadio/libc.go && $path != src/internal/gomadio/network.go && $path != src/internal/gomadio/transcript.go && $path != src/internal/gomadtrace/trace.go && $path != src/net/gomad.go && $path != src/os/gomad.go ]]; then

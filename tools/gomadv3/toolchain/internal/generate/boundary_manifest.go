...
func renderHookPolicy(policy hookPolicy, intercepts []intercept) ([]byte, error) {
	...
	source.WriteString("// Code generated by toolchain/cmd/gomadtool boundary-generate. DO NOT EDIT.\n\n")
...
func renderHostIdentity(definition manifest, identity string) ([]byte, error) {
	...
	source := fmt.Sprintf(`// Code generated by toolchain/cmd/gomadtool boundary-generate. DO NOT EDIT.

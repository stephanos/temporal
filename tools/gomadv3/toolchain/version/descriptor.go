...
func renderGo(descriptor Descriptor) ([]byte, error) {
	source := fmt.Sprintf(`// Code generated by toolchain/cmd/gomadtool version-generate. DO NOT EDIT.
...
`, descriptor.GoVersion, descriptor.BoundaryManifestVersion, descriptor.Patch, quotedGoStrings(descriptor.SupportedPlatforms), quotedGoAdapters(descriptor.Adapters))

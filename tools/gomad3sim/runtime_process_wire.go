...
const processProtocol = "gomad3.simulation-process/v3"
const processNodeBootstrapSchema = "gomad3.simulation-node-bootstrap/v1"
const processNodeTerminalSchema = "gomad3.simulation-node-terminal/v1"

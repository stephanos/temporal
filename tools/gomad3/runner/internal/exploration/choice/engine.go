...
import (
	...
	"go.temporal.io/server/tools/gomad3/runner/internal/exploration"
)
...
func ImplementationSHA256() record.SHA256 {
	return record.DomainHash("gomad3-choice-exploration-controller/v1", []byte(controllerIdentity))
}

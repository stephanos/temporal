...
func Run(arguments []string) error {
	...
	selection := flags.String("selection", "tools/umpire3/model/Temporal/API/testdata/fixtures/selection.json", "protobuf selection manifest")
	outputRoot := flags.String("output-root", "tools/umpire3/model/Temporal/API/Generated", "generated artifact directory")

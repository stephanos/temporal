...
**Size:** M
**Files:** `common/testing/temporaltestpilot/driver.go`, `common/testing/temporaltestpilot/worker/{api,driver,registry,interpreter}.go`, `common/testing/temporaltestpilot/internal/delivery/carrier.go`, focused tests
**Touches:** [common/testing/temporaltestpilot/driver.go, common/testing/temporaltestpilot/driver_test.go, common/testing/temporaltestpilot/worker/**, common/testing/temporaltestpilot/internal/delivery/**]
...
- `common/testing/temporaltestpilot/worker/api.go:25-38` — worker option surface
- `common/testing/temporaltestpilot/worker/driver.go:47-76,184-287` — construction and pure role/queue/endpoint resolution
- `common/testing/temporaltestpilot/worker/registry.go:117-141` — first worker side effects
- `common/testing/temporaltestpilot/internal/delivery/carrier.go:84-105,328-352` — existing physical carrier checks

**Optional** (reference as needed):
- `common/testing/temporaltestpilot/worker/interpreter.go:79-95` — Nexus endpoint consumption

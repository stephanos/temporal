...
- Apply fixed one-worker/two-workflow/one-operation-command/one-semantic-mutation/64-call/16-MiB-RawEvidence/eight-minute ceilings; evidence overflow or unresolved delivery ambiguity is non-accepted, never truncated into success.
...
- [ ] Server timeouts bound runner-loss residue and focused race/public-boundary tests pass within RawEvidence v2's 16-MiB cap.

...
## Description
Implement the serial path from outstanding canonical Case through `testpilot.Prepare`, one fresh `PreparedCase.Run`, cleanup, closed Verdict, and bridge observation. Preserve exact identities and separate preparation rejection from Run outcomes.
...
- [ ] Preparation rejection creates no Run; runtime/Driver/monitor/cleanup behavior follows fn-64 precedence.

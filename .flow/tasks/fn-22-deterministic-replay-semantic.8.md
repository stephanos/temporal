...
- [ ] Focused Lean, Go, `-tags test_dep`, integration, formatting and lint gates pass; the live negative-control proof runs through the command, and fails rather than skips without the replay bridge, which the live gate builds first.

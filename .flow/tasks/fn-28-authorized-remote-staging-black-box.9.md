...
satisfies: [R2, R3, R4]
---
# fn-28-authorized-remote-staging-black-box.9 Run the bounded black-box staging proof

## Description

Exercise one complete fixed staging lifecycle from v2 admission through cleanup, postflight, Run Evaluation, and ordinary publication.

**Size:** M
**Files:** `tools/umpire/staging/integration_test.go`
**Touches:** [`tools/umpire/staging/integration_test.go`]

### Approach
- Prove one-at-a-time public-gRPC Execution reuses the exact local subject and publishes no new member family or ArtifactSet version.

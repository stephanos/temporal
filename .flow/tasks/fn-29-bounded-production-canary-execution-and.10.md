...
**Size:** M
**Files:** `tools/umpire/temporal/canary/testharness/**`, `tools/umpire/remotequalification/**`, `tools/umpire/canaryqualification/integration_test.go`, `tools/umpire/cmd/umpire-qualify-production-canary/integration_test.go`
**Touches:** [tools/umpire/temporal/canary/testharness/**, tools/umpire/remotequalification/**, tools/umpire/canaryqualification/integration_test.go, tools/umpire/cmd/umpire-qualify-production-canary/integration_test.go]

### Approach
- Build one controlled TLS/public-Temporal boundary that exercises the production authority, target/routing, lease, participant, cleanup/postflight, evidence, conformance, qualification, construction, and publication interfaces without server-internal telemetry.

...
- Freeze the fn-19 source schema/version/digest table after that dependency lands and translate its four source kinds into fn-4's typed SyntheticEvidence while preserving order, causality, gaps, closure, correlations, and dispositions.

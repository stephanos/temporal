...
Place the generic native verification API under `Umpire.Verify.Native`. Receipts bind a named model-defined check/profile, source and semantic identities, assumptions, bounds, omissions, checker version, replay status, provenance, and honest trust class.

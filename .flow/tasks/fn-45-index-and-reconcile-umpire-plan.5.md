...
- `.plans/UMPIRE4_ORDER.md:180-208` — exact fn-17/fn-33 retained/deferred boundary.
...
- [ ] Existing task IDs remain usable, dependencies contain no deferred-only prerequisite, and Flow validation passes.
## Done summary
TBD

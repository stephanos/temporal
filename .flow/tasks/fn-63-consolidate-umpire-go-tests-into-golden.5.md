...
- Extend existing non-mutating temporary-root fixture checks and package commands only as required by the new layout; do not add broad generated API drift verification or a new CI workflow.
...
- `Makefile:1071-1083` — existing portable fixture generation/diff pattern

...
**Size:** M
**Files:** `tools/common/artifactio/artifact.go`, `tools/common/artifactio/artifact_test.go`, `tools/common/protofile/prefix.go`, `tools/common/protofile/prefix_test.go`, `tools/umpire/internal/artifactio/artifact.go`, `tools/umpire/internal/protofile/prefix.go`, `tools/umpire/internal/generate/api/main.go`, `tools/umpire/internal/generate/api/config.go`
**Touches:** [tools/common/artifactio/**, tools/common/protofile/**, tools/umpire/internal/artifactio/**, tools/umpire/internal/protofile/**, tools/umpire/internal/generate/api/main.go, tools/umpire/internal/generate/api/config.go]
...
- Update the Lean API generator imports to consume the common packages; do not otherwise refactor generator behavior.
...
- `tools/umpire/internal/generate/api/main.go:102-149` — artifact helper consumer
- `tools/umpire/internal/generate/api/config.go:95-109` — prefix helper consumer
...
- [ ] The Lean API generator imports the common packages and its focused tests pass.

...
- [ ] Credentials and raw coordinates never reach a Case, Run, Verdict, receipt, provenance, progress line or log: the Redactor is applied to every output and a test plants each credential and finds none.

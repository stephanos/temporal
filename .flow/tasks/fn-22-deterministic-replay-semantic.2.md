...
Classify repeated concrete reruns independently from Temporal SDK history replay. A history replay may report workflow-code compatibility or incompatibility but never model conformance, reproducibility of the full experiment, or semantic absence.

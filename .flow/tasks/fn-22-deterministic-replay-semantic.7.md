...
The command must require an explicit replay class and emit class-specific inputs, outcomes, trust, and omissions. Concrete reruns consume the shared runner/conformance path; SDK history replay is clearly diagnostic; promotion remains gated on canonical semantic replay.

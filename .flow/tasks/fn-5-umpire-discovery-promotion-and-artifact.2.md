...
- Route `umpire-inspect list` through the pure projection while preserving the existing
...
- `model/lakefile.toml` — existing `umpire-inspect` registration.

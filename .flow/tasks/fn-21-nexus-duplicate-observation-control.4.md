...
**Size:** M
**Files:** `tools/umpire/runtime/evidence.go`, `tools/umpire/internal/runtimeengine/evidence.go`, `tools/umpire/internal/runtimeengine/engine.go`, `tools/umpire/temporal/nexus/participant.go`, `tools/umpire/temporal/nexus/evidence.go`, `tools/umpire/temporal/nexus/output.go`, `tools/umpire/temporal/nexus/evidence_test.go`, `tools/umpire/temporal/nexus/integration_test.go`, `tools/umpire/temporal/nexus/testdata/caller-closure-duplicate-delivery-run-set/**`
**Touches:** [tools/umpire/runtime/evidence.go, tools/umpire/internal/runtimeengine/evidence.go, tools/umpire/internal/runtimeengine/engine.go, tools/umpire/temporal/nexus/participant.go, tools/umpire/temporal/nexus/evidence.go, tools/umpire/temporal/nexus/output.go, tools/umpire/temporal/nexus/evidence_test.go, tools/umpire/temporal/nexus/integration_test.go, tools/umpire/temporal/nexus/testdata/caller-closure-duplicate-delivery-run-set/**]

...
- [ ] Exact SDK worker options start without panic, process regular/sticky workflow plus Nexus tasks under one-slot Limits, and emit no activity poll or activity-task response.

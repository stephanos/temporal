...
- `cd model && mise exec -- lake build Umpire.Planning.Tests Umpire.Property.Tests Umpire.Query.Tests Umpire.Model.Tests.FiniteMachine Umpire.Model.Tests.FiniteTable Umpire.Model.Tests.Compatibility`: passed, 82 jobs (/tmp/fn78-task2-final-focused.log).

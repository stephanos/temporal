...
**Touches:** [common/testing/testpilot/driver.go, common/testing/testpilot/prepare.go, common/testing/testpilot/prepared_case.go, common/testing/testpilot/*_test.go, common/testing/temporaltestpilot/driver.go, common/testing/temporaltestpilot/driver_test.go, common/testing/temporaltestpilot/server/driver.go, common/testing/temporaltestpilot/server/driver_test.go, common/testing/temporaltestpilot/sdkworker/driver.go, common/testing/temporaltestpilot/sdkworker/*_test.go, tests/testcore/testpilot/artifact_test.go]
...
- `common/testing/temporaltestpilot/sdkworker/driver.go` — SDK worker Driver implementation

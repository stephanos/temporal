...
### Approach
- Define the sole supported Nexus success entry with exact packaged digest, checked provenance identity and bounded environment configuration. Production catalog owns deployment ProfileSpec using the public catalog helper and existing binding IDs; never import test fixture helpers or generators.

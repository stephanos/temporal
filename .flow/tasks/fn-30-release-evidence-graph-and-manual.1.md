...
**Size:** M
**Files:** focused modules/tests under `model/Umpire/Qualification/Release/`, `model/Temporal/System/Qualification/Release.lean` and tests, fixed policy executable entry point/manifest, umbrella/lake declarations
**Touches:** [model/Umpire/Qualification/Release.lean, model/Umpire/Qualification/Release/**, model/Temporal/System/Qualification/Release.lean, model/Temporal/System/Qualification/ReleaseTests.lean, model/Temporal/System/Qualification/ReleasePolicyMain.lean, model/Umpire.lean, model/Temporal/System.lean, model/lakefile.toml]
...
- Compile the exact candidate schema, four evidence profiles/versions, freshness windows, omission policy, trust roles, and decision rules in the Temporal system module.
- Define canonical `ReleasePolicyInput/v1` and `ReleasePolicyOutput/v1` plus one stdin/stdout Lean executable and generated manifest binding its SHA-256 to `ReleasePolicy/v1`; it reads no files, environment, network, clock, or secrets.
...
- [ ] The Temporal policy fixes all candidate, slot, profile, version, age, limit, omission, trust-role, and terminal-decision constants from the parent spec.
...
- [ ] `cd model && mise exec -- lake build Umpire.Qualification.Release.Tests Temporal.System.Qualification.ReleaseTests` passes.
## Acceptance

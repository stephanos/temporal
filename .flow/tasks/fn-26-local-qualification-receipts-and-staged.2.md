...
## Acceptance
- [ ] Missing, extra, crossed (a correlated-only Case included), stale, incompatible, open (an empty Run ID or no events included), inconsistent, or noncanonical subjects reject.

...
**Files:** `model/Temporal/Feature/Nexus/Race/**` (from `Nexus2/`), `model/Temporal/Feature/Nexus/Success/**` (from `Nexus3/`), `model/Temporal/Feature/Nexus/Race/Terminal.lean` (from `Nexus3/Cancellation.lean`), `model/Temporal/Feature.lean`, `model/Temporal/System/Nexus/{ImplementationLink,ImplementationLinkTests}.lean`, deletion of `model/Temporal/ImplementationLinkTests/`, `model/TemporalModelTests.lean`, `model/TemporalExperimentalTests.lean`, `model/Temporal/Feature/Nexus/{,Race/}COVERAGE.md`, `model/lakefile.lean`, `Makefile`, `model/ModelLint/ImportGraph.lean` + tests, `tests/*` live test names, docs, gate
**Touches:** [model/Temporal/**, model/TemporalModelTests.lean, model/TemporalExperimentalTests.lean, model/lakefile.lean, model/ModelLint/**, model/README.md, Makefile, tests/**, tools/umpire/regression/ci_workflow_test.go, tools/umpire/internal/retiredvocabulary/check.go, .flow/specs/*.md]
...
- Tools: Lake exes `temporal-model-inspect` to `umpire-inspect`, `temporal-testpilot` to `umpire-case`, `modelLint`/`modelLintTests` to `umpire-lint`/`umpire-lint-tests`, `testpilotProtoJSONFixture` to `umpire-protojson-fixture`, `umpire-scoped-fixtures` to `umpire-correlated-fixtures`; Makefile variables at `Makefile:120-126` and targets `umpire-list-nexus`/`umpire-explain-nexus` to `umpire-list`/`umpire-explain`; `lint-model` keeps its name. Update `tools/umpire/regression/ci_workflow_test.go` where it pins target names.
...
- [ ] Lake executables and Make targets use the `umpire-` convention; `make umpire-inspect`, `umpire-list`, `umpire-explain`, `umpire-check-regression` pass

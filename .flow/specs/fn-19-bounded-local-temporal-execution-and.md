...
The runtime publishes failed/incomplete operational attempts because failures are evidence. Semantic interpretation stays downstream so a successful force-close request cannot be mislabeled as caller-closure Run Evaluation.

...
- `GOMAD3_PKG.md` is an earlier package cleanup review whose measurements and recommendations predate substantial runner/simulation growth. This report supersedes it; archive or delete it after any still-relevant notes are transferred.

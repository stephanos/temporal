...
### 1. fn-48 — Canonicalize Known Gaps as a checked set

**Depends on:** completed fn-43 and the existing semantic outcome/Known Gap inventory.
...
### 2. fn-49 — Centralize Observation field and structural contracts
...
### 3. fn-51 — Shorten ordinary model authoring
...
### 4. fn-52 — Caller-neutral gRPC portable test plans
...
```text
completed fn-43 -> {fn-48, fn-49, fn-51}

...
### 1. fn-43 — Deepen ordinary Property, Behavior, and Query authoring
...
### 2. fn-48 — Canonicalize Known Gaps as a checked set
...
### 3. fn-49 — Centralize Observation field and structural contracts
...
### 4. fn-51 — Shorten ordinary model authoring
...
### 5. fn-52 — Caller-neutral gRPC portable test plans
...
```text
completed fn-40 -> fn-43 -> {fn-48, fn-49, fn-51}

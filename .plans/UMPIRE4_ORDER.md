...
### 1. fn-40 — Centralize PlannerPolicy constructors and default seed

**Depends on:** completed fn-17's Query strategy rename to `seeded`.
...
### 2. fn-43 — Deepen ordinary Property, Behavior, and Query authoring
...
### 3. fn-48 — Canonicalize Known Gaps as a checked set
...
### 4. fn-49 — Centralize Observation field and structural contracts
...
### 5. fn-51 — Shorten ordinary model authoring
...
### 6. fn-52 — Caller-neutral gRPC portable test plans
...
```text
completed fn-17 -> fn-40 -> fn-43 -> {fn-48, fn-49, fn-51}

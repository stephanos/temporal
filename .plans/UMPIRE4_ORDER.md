...
### 1. fn-56 — Split Lean API generator planning from rendering
...
### 2. fn-57 — Partition the Observation authoring language
...
### 3. fn-54 — Decompose the Observation evaluator behind its facade
...
### 4. fn-58 — Partition the Property language implementation
